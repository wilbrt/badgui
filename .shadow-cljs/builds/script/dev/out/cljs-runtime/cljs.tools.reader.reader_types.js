...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25991 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25991(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25992 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25992(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25994 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25994(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26003 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26003(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26005 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26005(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26006 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26006(reader);
}
});
...
var G__26109 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26110 = s.append(c);
c = G__26109;
s = G__26110;
continue;
}
