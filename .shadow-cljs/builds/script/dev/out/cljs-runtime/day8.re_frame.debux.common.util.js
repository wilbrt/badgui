...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__34142){
var vec__34143 = p__34142;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34143,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34143,(1),null);
...
return clojure.zip.zipper((function (p1__34149_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__34149_SHARP_)) || (cljs.core.map_QMARK_(p1__34149_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__34154){
var vec__34155 = p__34154;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34155,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34155,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34162_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__34162_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34161_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34161_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34163_SHARP_){
return (((p1__34163_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__34163_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__34179,mapping){
var map__34180 = p__34179;
var map__34180__$1 = cljs.core.__destructure_map(map__34180);
var state = map__34180__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34180__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34180__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34180__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34177_SHARP_){
var and__4251__auto__ = (p1__34177_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__34177_SHARP_);
} else {
...
var G__34262 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__34263 = clojure.zip.next(loc);
loc = G__34263;
continue;
}
}
...
var G__34274 = (i__4865__auto___34272 + (1));
i__4865__auto___34272 = G__34274;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__34193){
var vec__34194 = p__34193;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34194,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq34190){
var G__34191 = cljs.core.first(seq34190);
var seq34190__$1 = cljs.core.next(seq34190);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34191,seq34190__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34201_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__34201_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__34204_34282 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__34205_34283 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__34206_34284 = true;
var _STAR_print_fn_STAR__temp_val__34207_34285 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__34206_34284);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__34207_34285);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__34205_34283);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__34204_34282);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34203_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__34203_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__34286 = cljs.core.next(opts__$1);
var G__34287 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__34286;
acc = G__34287;
continue;
} else {
if(typeof f === 'string'){
var G__34288 = cljs.core.next(opts__$1);
var G__34289 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__34288;
acc = G__34289;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__34290 = cljs.core.nnext(opts__$1);
var G__34291 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__34290;
acc = G__34291;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__34292 = cljs.core.next(opts__$1);
var G__34293 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__34292;
acc = G__34293;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__34212 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__34212.cljs$core$IFn$_invoke$arity$1 ? fexpr__34212.cljs$core$IFn$_invoke$arity$1(f) : fexpr__34212.call(null,f));
})())){
var G__34294 = cljs.core.next(opts__$1);
var G__34295 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__34294;
acc = G__34295;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__34213 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__34213.cljs$core$IFn$_invoke$arity$1 ? fexpr__34213.cljs$core$IFn$_invoke$arity$1(f) : fexpr__34213.call(null,f));
})())){
var G__34296 = cljs.core.nnext(opts__$1);
var G__34297 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__34296;
acc = G__34297;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__34298 = cljs.core.next(opts__$1);
var G__34299 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__34298;
acc = G__34299;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__34214){
var vec__34215 = p__34214;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34215,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34215,(1),null);
...
var G__34220 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__34219 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__34223 = quoted_form;
var G__34224 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__34223,G__34224) : day8.re_frame.debux.common.util.remove_d.call(null,G__34223,G__34224));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__34225 = quoted_form;
var G__34226 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__34225,G__34226) : day8.re_frame.debux.common.util.remove_d.call(null,G__34225,G__34226));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__34300__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__34230 = quoted_form;
var G__34231 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__34230,G__34231) : day8.re_frame.debux.common.util.remove_d.call(null,G__34230,G__34231));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__34301__i < G__34301__a.length) {G__34301__a[G__34301__i] = arguments[G__34301__i + 0]; ++G__34301__i;}
  arg = new cljs.core.IndexedSeq(G__34301__a,0,null);
} 
return G__34300__delegate.call(this,arg);};
G__34300.cljs$lang$maxFixedArity = 0;
G__34300.cljs$lang$applyTo = (function (arglist__34302){
var arg = cljs.core.seq(arglist__34302);
return G__34300__delegate(arg);
});
...
var G__34303 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__34303;
continue;
} else {
...
var G__34304 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__34304;
continue;
} else {
var G__34305 = clojure.zip.next(loc);
loc = G__34305;
continue;
