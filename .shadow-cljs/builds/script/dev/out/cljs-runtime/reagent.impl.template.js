...
var G__31285 = o;
reagent.impl.template.goog$module$goog$object.set(G__31285,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__31286 = o;
reagent.impl.template.goog$module$goog$object.set(G__31286,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__31332__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__31333__i < G__31333__a.length) {G__31333__a[G__31333__i] = arguments[G__31333__i + 0]; ++G__31333__i;}
  args = new cljs.core.IndexedSeq(G__31333__a,0,null);
} 
return G__31332__delegate.call(this,args);};
G__31332.cljs$lang$maxFixedArity = 0;
G__31332.cljs$lang$applyTo = (function (arglist__31334){
var args = cljs.core.seq(arglist__31334);
return G__31332__delegate(args);
});
...
var G__31287 = props;
var G__31287__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31287,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31287);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31287__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31288 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31288,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31288;
}
})(),id_class);
...
var G__31289 = (cljs.core.count(argv) - first_child);
switch (G__31289) {
case (0):
...
var vec__31290 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31290,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31290,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31290,(2),null);
...
var temp__5757__auto___31341 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___31341 == null)){
} else {
var key_31342 = temp__5757__auto___31341;
(jsprops.key = key_31342);
}
...
var temp__5757__auto___31343 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___31343 == null)){
} else {
var key_31344 = temp__5757__auto___31343;
(jsprops.key = key_31344);
}
...
var temp__5757__auto___31345 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___31345 == null)){
} else {
var key_31346 = temp__5757__auto___31345;
(jsprops.key = key_31346);
}
...
var temp__5757__auto___31382 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___31382 == null)){
} else {
var key_31383 = temp__5757__auto___31382;
(jsprops.key = key_31383);
}
...
var temp__5757__auto___31384 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31293_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__31293_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__31297 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31297,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31297,(1),null);
...
break;
default:
var G__31395 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__31396 = compiler;
v = G__31395;
compiler = G__31396;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template31312 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template31312 = (function (opts,id,fn_to_element,parse_fn,meta31313){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template31312.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31314,meta31313__$1){
var self__ = this;
var _31314__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template31312(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta31313__$1));
}));

(reagent.impl.template.t_reagent$impl$template31312.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31314){
var self__ = this;
var _31314__$1 = this;
return self__.meta31313;
}));

(reagent.impl.template.t_reagent$impl$template31312.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template31312.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template31312.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template31312.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template31312.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template31312.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta31313","meta31313",1791549257,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template31312.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template31312.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template31312");

(reagent.impl.template.t_reagent$impl$template31312.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template31312");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template31312.
 */
reagent.impl.template.__GT_t_reagent$impl$template31312 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template31312(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31313){
return (new reagent.impl.template.t_reagent$impl$template31312(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31313));
});

}

return (new reagent.impl.template.t_reagent$impl$template31312(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
