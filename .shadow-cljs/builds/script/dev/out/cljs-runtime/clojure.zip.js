...
var G__32650 = clojure.zip.node(loc);
var fexpr__32649 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__32649.cljs$core$IFn$_invoke$arity$1 ? fexpr__32649.cljs$core$IFn$_invoke$arity$1(G__32650) : fexpr__32649.call(null,G__32650));
});
/**
...
var G__32658 = clojure.zip.node(loc);
var fexpr__32657 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__32657.cljs$core$IFn$_invoke$arity$1 ? fexpr__32657.cljs$core$IFn$_invoke$arity$1(G__32658) : fexpr__32657.call(null,G__32658));
} else {
...
var fexpr__32659 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__32659.cljs$core$IFn$_invoke$arity$2 ? fexpr__32659.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__32659.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__32673 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32673,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32673,(1),null);
var vec__32676 = clojure.zip.children(loc);
...
var vec__32681 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32681,(0),null);
var map__32684 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32681,(1),null);
var map__32684__$1 = cljs.core.__destructure_map(map__32684);
var path = map__32684__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32684__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32684__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32684__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32684__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32684__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__32687 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32687,(0),null);
var map__32690 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32687,(1),null);
var map__32690__$1 = cljs.core.__destructure_map(map__32690);
var path = map__32690__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32690__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__32691 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32690__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__32696 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32696,(0),null);
var map__32699 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32696,(1),null);
var map__32699__$1 = cljs.core.__destructure_map(map__32699);
var path = map__32699__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32699__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32699__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return r;
} else {
...
var vec__32700 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32700,(0),null);
var map__32703 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32700,(1),null);
var map__32703__$1 = cljs.core.__destructure_map(map__32703);
var path = map__32703__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32703__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32703__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
...
var vec__32710 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32710,(0),null);
var map__32713 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32710,(1),null);
var map__32713__$1 = cljs.core.__destructure_map(map__32713);
var path = map__32713__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32713__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32713__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__32714 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32714,(0),null);
var map__32717 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32714,(1),null);
var map__32717__$1 = cljs.core.__destructure_map(map__32717);
var path = map__32717__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32717__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__32718 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32718,(0),null);
var map__32721 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32718,(1),null);
var map__32721__$1 = cljs.core.__destructure_map(map__32721);
var path = map__32721__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32721__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__32724 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32724,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32724,(1),null);
...
var len__4864__auto___32795 = arguments.length;
var i__4865__auto___32796 = (0);
while(true){
if((i__4865__auto___32796 < len__4864__auto___32795)){
args__4870__auto__.push((arguments[i__4865__auto___32796]));

var G__32797 = (i__4865__auto___32796 + (1));
i__4865__auto___32796 = G__32797;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq32728){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32729,G__32730,seq32728__$2);
}));
...
var G__32804 = clojure.zip.rightmost(child);
loc__$1 = G__32804;
continue;
} else {
return loc__$1;
...
var vec__32748 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32748,(0),null);
var map__32751 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32748,(1),null);
var map__32751__$1 = cljs.core.__destructure_map(map__32751);
var path = map__32751__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32751__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32751__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32751__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32751__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__32808 = clojure.zip.rightmost(child);
loc__$1 = G__32808;
continue;
} else {
return loc__$1;
