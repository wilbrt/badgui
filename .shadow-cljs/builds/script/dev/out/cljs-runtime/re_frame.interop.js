...
return [(function (){var pred__31493 = cljs.core.instance_QMARK_;
var expr__31494 = reactive_val;
if(cljs.core.truth_((pred__31493.cljs$core$IFn$_invoke$arity$2 ? pred__31493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__31494) : pred__31493.call(null,reagent.ratom.RAtom,expr__31494)))){
return "ra";
} else {
if(cljs.core.truth_((pred__31493.cljs$core$IFn$_invoke$arity$2 ? pred__31493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__31494) : pred__31493.call(null,reagent.ratom.RCursor,expr__31494)))){
return "rc";
} else {
if(cljs.core.truth_((pred__31493.cljs$core$IFn$_invoke$arity$2 ? pred__31493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__31494) : pred__31493.call(null,reagent.ratom.Reaction,expr__31494)))){
return "rx";
} else {
if(cljs.core.truth_((pred__31493.cljs$core$IFn$_invoke$arity$2 ? pred__31493.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__31494) : pred__31493.call(null,reagent.ratom.Track,expr__31494)))){
return "tr";
} else {
return "other";
}
