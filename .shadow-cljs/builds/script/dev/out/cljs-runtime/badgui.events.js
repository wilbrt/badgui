...
badgui.events.websocket_effect = (function badgui$events$websocket_effect(p__35019){
var map__35020 = p__35019;
var map__35020__$1 = cljs.core.__destructure_map(map__35020);
var request = map__35020__$1;
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35020__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var on_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35020__$1,new cljs.core.Keyword(null,"on-message","on-message",1662987808));
var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35020__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35020__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35020__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
var existing_websocket = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35020__$1,new cljs.core.Keyword(null,"existing-websocket","existing-websocket",-1682552812));
...
(websocket.onmessage = (function (p1__35016_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_message,p1__35016_SHARP_));
}));

(websocket.onerror = (function (p1__35017_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_failure,p1__35017_SHARP_));
}));

return (websocket.onopen = (function badgui$events$websocket_effect_$_on_open(){
(websocket.onerror = (function (p1__35018_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_error,p1__35018_SHARP_));
}));
...
var result__34867__auto__ = (function (){var result__34878__auto__ = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3((function (){var result__34867__auto__ = badgui.db.default_db;
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431),1,new cljs.core.Keyword(null,"syntax-order","syntax-order",-990682045),(2),new cljs.core.Keyword(null,"result","result",1415092211),result__34867__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol("db","default-db","db/default-db",-1149096552,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__34867__auto__;
})(),new cljs.core.Keyword(null,"connecting","connecting",-1347943866),true);
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431),1,new cljs.core.Keyword(null,"syntax-order","syntax-order",-990682045),(3),new cljs.core.Keyword(null,"result","result",1415092211),result__34878__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"assoc","assoc",2071440380,null),new cljs.core.Keyword(null,"connecting","connecting",-1347943866),true),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__34878__auto__;
})();
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431),1,new cljs.core.Keyword(null,"syntax-order","syntax-order",-990682045),(1),new cljs.core.Keyword(null,"result","result",1415092211),result__34867__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"->","->",-2139605430,null),new cljs.core.Symbol("db","default-db","db/default-db",-1149096552,null),cljs.core.list(new cljs.core.Symbol(null,"assoc","assoc",2071440380,null),new cljs.core.Keyword(null,"connecting","connecting",-1347943866),true)),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results-succes","badgui.events/fetch-results-succes",-2023610374),(function (db,p__35033){
...
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35037,(0),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"name","name",1843675177),val);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results","badgui.events/fetch-results",-97171637),(function (p__35040,_){
var map__35041 = p__35040;
var map__35041__$1 = cljs.core.__destructure_map(map__35041);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35041__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","boxit","badgui.events/boxit",-1656565434),(function (p__35042,p__35043){
var map__35044 = p__35042;
...
var vec__35045 = p__35043;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35045,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35045,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","box-handler","badgui.events/box-handler",-258012506),(function (db,p__35048){
var vec__35049 = p__35048;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35049,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35049,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","msg-handler","badgui.events/msg-handler",2031488510),(function (_,p__35052){
var vec__35053 = p__35052;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35053,(0),null);
var message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35053,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-handler","badgui.events/update-handler",-1991805487),(function (_,p__35056){
var vec__35057 = p__35056;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35057,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35057,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","add-ongoing","badgui.events/add-ongoing",885410952),(function (db,p__35060){
var vec__35061 = p__35060;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35061,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35061,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-backend","badgui.events/update-backend",-1266821368),(function (db,p__35064){
var vec__35065 = p__35064;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35065,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35065,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","failure-post-result","badgui.events/failure-post-result",-1717777957),(function (db,p__35068){
var vec__35069 = p__35068;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35069,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35069,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","change-ongoing","badgui.events/change-ongoing",-1544430184),(function (db,p__35072){
var vec__35073 = p__35072;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35073,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35073,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","del-ongoing","badgui.events/del-ongoing",273228564),(function (db,p__35076){
var vec__35077 = p__35076;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35077,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35077,(1),null);
