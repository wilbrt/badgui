...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__33032){
var map__33033 = p__33032;
var map__33033__$1 = cljs.core.__destructure_map(map__33033);
var request = map__33033__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33033__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__33036 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__33036.cljs$core$IFn$_invoke$arity$1 ? fexpr__33036.cljs$core$IFn$_invoke$arity$1(response) : fexpr__33036.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__33041 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__33041.cljs$core$IFn$_invoke$arity$1 ? fexpr__33041.cljs$core$IFn$_invoke$arity$1(response) : fexpr__33041.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__33045){
