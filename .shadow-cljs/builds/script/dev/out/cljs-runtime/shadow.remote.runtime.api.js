...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26341 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26341(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_26342 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_26342(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_26343 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_26343(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_26345 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_26345(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26351 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26351(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26355 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26355(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__26335,callback){
var map__26337 = p__26335;
var map__26337__$1 = cljs.core.__destructure_map(map__26337);
var input = map__26337__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26337__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26337__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
