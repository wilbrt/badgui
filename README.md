...
* [`src/badup/`](src/badup/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/badup/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `badup` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/badup/config.cljs) defaults to `true` in
...
```clj
(ns badup.example
  (:require [badup.config :as config])
