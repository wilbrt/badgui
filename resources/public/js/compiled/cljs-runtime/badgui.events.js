...
badgui.events.websocket_effect = (function badgui$events$websocket_effect(p__27984){
var map__27985 = p__27984;
var map__27985__$1 = cljs.core.__destructure_map(map__27985);
var request = map__27985__$1;
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27985__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var on_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27985__$1,new cljs.core.Keyword(null,"on-message","on-message",1662987808));
var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27985__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27985__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27985__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
var existing_websocket = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27985__$1,new cljs.core.Keyword(null,"existing-websocket","existing-websocket",-1682552812));
...
(websocket.onmessage = (function (p1__27981_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_message,p1__27981_SHARP_));
}));

(websocket.onerror = (function (p1__27982_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_failure,p1__27982_SHARP_));
}));

return (websocket.onopen = (function badgui$events$websocket_effect_$_on_open(){
(websocket.onerror = (function (p1__27983_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_error,p1__27983_SHARP_));
}));
...
return cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27986_SHARP_){
return ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"played","played",-1713723590).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"playerA","playerA",-270093465).cljs$core$IFn$_invoke$arity$1(p1__27986_SHARP_)),sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"playerA","playerA",-270093465).cljs$core$IFn$_invoke$arity$1(p1__27986_SHARP_)),name)))) || (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"played","played",-1713723590).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"playerA","playerA",-270093465).cljs$core$IFn$_invoke$arity$1(p1__27986_SHARP_)),sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"playerA","playerA",-270093465).cljs$core$IFn$_invoke$arity$1(p1__27986_SHARP_)),name)))));
}),data));
});
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27987_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"playerA","playerA",-270093465).cljs$core$IFn$_invoke$arity$1(p1__27987_SHARP_)))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"playerB","playerB",-1206753306).cljs$core$IFn$_invoke$arity$1(p1__27987_SHARP_)))));
}),data);
});
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-name","badgui.events/update-name",933633455),(function (db,p__27989){
var vec__27990 = p__27989;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27990,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27990,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"name","name",1843675177),val);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results","badgui.events/fetch-results",-97171637),(function (p__27993,_){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results-success","badgui.events/fetch-results-success",-1077480533),(function (db,p__27995){
var vec__27996 = p__27995;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27996,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27996,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results-failure","badgui.events/fetch-results-failure",-596311799),(function (db,p__27999){
var vec__28000 = p__27999;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28000,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28000,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-next","badgui.events/fetch-next",1770593481),(function (_,p__28003){
var vec__28004 = p__28003;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28004,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28004,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","msg-handler","badgui.events/msg-handler",2031488510),(function (_,p__28007){
var vec__28008 = p__28007;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28008,(0),null);
var message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28008,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-handler","badgui.events/update-handler",-1991805487),(function (_,p__28011){
var vec__28012 = p__28011;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28012,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","add-ongoing","badgui.events/add-ongoing",885410952),(function (db,p__28015){
var vec__28016 = p__28015;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28016,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28016,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","change-ongoing","badgui.events/change-ongoing",-1544430184),(function (db,p__28019){
var vec__28020 = p__28019;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28020,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28020,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","del-ongoing","badgui.events/del-ongoing",273228564),(function (db,p__28023){
var vec__28024 = p__28023;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28024,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28024,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","boxit","badgui.events/boxit",-1656565434),(function (p__28027,p__28028){
var map__28029 = p__28027;
var map__28029__$1 = cljs.core.__destructure_map(map__28029);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28029__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__28030 = p__28028;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28030,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28030,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","box-calc","badgui.events/box-calc",-1340887398),(function (db,p__28033){
var vec__28034 = p__28033;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28034,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28034,(1),null);
