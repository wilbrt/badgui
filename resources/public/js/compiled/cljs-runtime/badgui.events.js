...
badgui.events.websocket_effect = (function badgui$events$websocket_effect(p__29174){
var map__29175 = p__29174;
var map__29175__$1 = cljs.core.__destructure_map(map__29175);
var request = map__29175__$1;
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29175__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var on_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29175__$1,new cljs.core.Keyword(null,"on-message","on-message",1662987808));
var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29175__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29175__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29175__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
var existing_websocket = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29175__$1,new cljs.core.Keyword(null,"existing-websocket","existing-websocket",-1682552812));
...
(websocket.onmessage = (function (p1__29171_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_message,p1__29171_SHARP_));
}));

(websocket.onerror = (function (p1__29172_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_failure,p1__29172_SHARP_));
}));

return (websocket.onopen = (function badgui$events$websocket_effect_$_on_open(){
(websocket.onerror = (function (p1__29173_SHARP_){
return re_frame.core.dispatch(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(on_error,p1__29173_SHARP_));
}));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results-succes","badgui.events/fetch-results-succes",-2023610374),(function (db,p__29177){
var vec__29178 = p__29177;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29178,(0),null);
var vec__29181 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29178,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29181,(0),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"name","name",1843675177),val);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","fetch-results","badgui.events/fetch-results",-97171637),(function (p__29184,_){
var map__29185 = p__29184;
var map__29185__$1 = cljs.core.__destructure_map(map__29185);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29185__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","boxit","badgui.events/boxit",-1656565434),(function (p__29186,p__29187){
var map__29188 = p__29186;
...
var vec__29189 = p__29187;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29189,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","box-handler","badgui.events/box-handler",-258012506),(function (db,p__29192){
var vec__29193 = p__29192;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29193,(1),null);
var handled = cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(data);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"box","box",1530920394),new cljs.core.Keyword(null,"show","show",-576705889)], null),true),new cljs.core.Keyword(null,"searchf","searchf",1254147720)),new cljs.core.Keyword(null,"loading","loading",-737050189),false),new cljs.core.Keyword(null,"box","box",1530920394),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(handled,new cljs.core.Keyword(null,"results","results",-1134170113))),new cljs.core.Keyword(null,"history","history",-247395220),new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(handled)),new cljs.core.Keyword(null,"pagenum","pagenum",1067092365),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"max","max",61366548),cljs.core.count(cljs.core.partition.cljs$core$IFn$_invoke$arity$2((5),new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(handled))),new cljs.core.Keyword(null,"now","now",-1650525531),(0)], null));
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","del-box","badgui.events/del-box",-156801454),(function (db,_){
return cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"box","box",1530920394),new cljs.core.Keyword(null,"show","show",-576705889)], null),false);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","msg-handler","badgui.events/msg-handler",2031488510),(function (_,p__29196){
var vec__29197 = p__29196;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29197,(0),null);
var message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29197,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-handler","badgui.events/update-handler",-1991805487),(function (_,p__29200){
var vec__29201 = p__29200;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29201,(0),null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29201,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","add-ongoing","badgui.events/add-ongoing",885410952),(function (db,p__29204){
var vec__29205 = p__29204;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29205,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29205,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-backend","badgui.events/update-backend",-1266821368),(function (db,p__29208){
var vec__29209 = p__29208;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29209,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29209,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","failure-post-result","badgui.events/failure-post-result",-1717777957),(function (db,p__29212){
var vec__29213 = p__29212;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29213,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29213,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","change-ongoing","badgui.events/change-ongoing",-1544430184),(function (db,p__29216){
var vec__29217 = p__29216;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29217,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29217,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","del-ongoing","badgui.events/del-ongoing",273228564),(function (db,p__29220){
var vec__29221 = p__29220;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29221,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29221,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","update-search","badgui.events/update-search",-2147115520),(function (db,p__29224){
var vec__29225 = p__29224;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29225,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29225,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"searchf","searchf",1254147720),value);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("badgui.events","pagenumber","badgui.events/pagenumber",2069206451),(function (db,p__29228){
var vec__29229 = p__29228;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29229,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29229,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pagenum","pagenum",1067092365),new cljs.core.Keyword(null,"now","now",-1650525531)], null),cljs.core._PLUS_,value);
}));
