...
var len__4864__auto___28567 = arguments.length;
var i__4865__auto___28570 = (0);
while(true){
if((i__4865__auto___28570 < len__4864__auto___28567)){
args__4870__auto__.push((arguments[i__4865__auto___28570]));

var G__28572 = (i__4865__auto___28570 + (1));
i__4865__auto___28570 = G__28572;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28460){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28461,G__28462,seq28460__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28498_SHARP_){
return (!((cljs.core.meta(p1__28498_SHARP_) == null)));
})))){
...
}catch (e28519){var _e__27208__auto__ = e28519;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e28521){var _e__27208__auto__ = e28521;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28528 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28529 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28529);

try{var map__28530 = opts;
var map__28530__$1 = cljs.core.__destructure_map(map__28530);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28530__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28528);
}});
...
var temp__5751__auto___28607 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28607)){
var managed_print_level_28608 = temp__5751__auto___28607;
var _STAR_print_level_STAR__orig_val__28550_28609 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28551_28610 = managed_print_level_28608;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28551_28610);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28544_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28544_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28550_28609);
}} else {
job_fn();
}
