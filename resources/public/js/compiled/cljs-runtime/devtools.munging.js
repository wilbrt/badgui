...
var o27525 = temp__5751__auto__;
var temp__5751__auto____$1 = (o27525["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27526 = temp__5751__auto____$1;
return (o27526["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27119__auto__ = f;
return (o__27119__auto__["toString"]).call(o__27119__auto__);
} else {
return "";
}
}catch (e27531){var _ = e27531;
return "";
}});
...
try{var o__27119__auto___27835 = t;
(o__27119__auto___27835["cljs$lang$ctorPrWriter"]).call(o__27119__auto___27835,t,writer);
}catch (e27536){var __27837 = e27536;
}
...
var char_code = (function (){var o__27119__auto__ = (new String(char$));
return (o__27119__auto__["charCodeAt"]).call(o__27119__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27119__auto__ = String;
return (o__27119__auto__["fromCharCode"]).call(o__27119__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27545 = num_code;
switch (G__27545) {
case (1):
return (185);
...
var o__27119__auto__ = String;
return (o__27119__auto__["fromCharCode"]).call(o__27119__auto__,superscript_code);
});
/**
...
}catch (e27556){var _e__27208__auto__ = e27556;
return false;
}})())){
...
var vec__27559 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27559,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27582){
var vec__27584 = p__27582;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27584,(0),null);
...
var G__27848 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27849 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27848;
remaining_tokens = G__27849;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27577){
var G__27578 = cljs.core.first(seq27577);
var seq27577__$1 = cljs.core.next(seq27577);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27578,seq27577__$1);
}));
...
var vec__27600 = cljs.core.split_with((function (p1__27592_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27592_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27600,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27600,(1),null);
...
var vec__27613 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27613,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27613,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27853 = cljs.core.rest(remaining_tokens);
var G__27854 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27853;
name_tokens = G__27854;
continue;
} else {
...
var vec__27626 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27626,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27626,(1),null);
var vec__27629 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27629,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27629,(1),null);
var vec__27632 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27632,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27632,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27632,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27632,(3),null);
...
var vec__27655 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27655,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27655,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27655,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27655,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27655,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27655,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27662 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27662,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27662,(1),null);
var vec__27665 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27665,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27665,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27677 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27677) : devtools.munging.parse_fn_info_deep.call(null,G__27677));
})()));
}
} else {
return fn_info;
...
var G__27896 = (arity + (1));
var G__27897 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27704_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27704_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27705_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27705_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___27906 = arguments.length;
var i__4865__auto___27907 = (0);
while(true){
if((i__4865__auto___27907 < len__4864__auto___27906)){
args__4870__auto__.push((arguments[i__4865__auto___27907]));

var G__27908 = (i__4865__auto___27907 + (1));
i__4865__auto___27907 = G__27908;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27710){
var vec__27713 = p__27710;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27713,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27707){
var G__27708 = cljs.core.first(seq27707);
var seq27707__$1 = cljs.core.next(seq27707);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27708,seq27707__$1);
}));
...
var map__27758 = options;
var map__27758__$1 = cljs.core.__destructure_map(map__27758);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27758__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27758__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27758__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27758__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27761 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(5),null);
...
var o__27119__auto__ = f;
return (o__27119__auto__["getBasis"]).call(o__27119__auto__);
});
/**
...
}catch (e27797){var _e__27208__auto__ = e27797;
...
var G__27939 = (obj[cljs.core.first(path)]);
var G__27940 = cljs.core.rest(path);
obj = G__27939;
path = G__27940;
continue;
} else {
...
var _STAR_ = (function (accum,p__27812){
var vec__27813 = p__27812;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27813,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27813,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27816){
var vec__27817 = p__27816;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27817,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27817,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27817,(2),null);
...
var post_process = (function (p__27826){
var vec__27827 = p__27826;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27827,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27827,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27824_SHARP_){
return (obj[cljs.core.first(p1__27824_SHARP_)]);
}),sorted_matches);
