...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__39588){
var map__39589 = p__39588;
var map__39589__$1 = cljs.core.__destructure_map(map__39589);
var request = map__39589__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39589__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__39594 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__39594.cljs$core$IFn$_invoke$arity$1 ? fexpr__39594.cljs$core$IFn$_invoke$arity$1(response) : fexpr__39594.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__39595 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__39595.cljs$core$IFn$_invoke$arity$1 ? fexpr__39595.cljs$core$IFn$_invoke$arity$1(response) : fexpr__39595.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__39596){
var map__39597 = p__39596;
var map__39597__$1 = cljs.core.__destructure_map(map__39597);
var request = map__39597__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39597__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
