...
var i_32347 = (0);
while(true){
if((i_32347 < arr.length)){
(arr[i_32347] = null);

var G__32348 = (i_32347 + (1));
i_32347 = G__32348;
continue;
} else {
}
...
var i_32359 = (self__.level + (1));
while(true){
if((i_32359 <= (new_level + (1)))){
(update[i_32359] = self__.header);

var G__32360 = (i_32359 + (1));
i_32359 = G__32360;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32361 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32361[i]));
} else {
x__$2.forward.push((((i < links_32361.length))?(links_32361[i]):null));
}

if((i < links_32361.length)){
(links_32361[i] = x__$2);
} else {
links_32361.push(x__$2);
}
...
var i_32363 = (0);
while(true){
if((i_32363 <= self__.level)){
var links_32364 = (update[i_32363]).forward;
if((x__$1 === (((i_32363 < links_32364.length))?(links_32364[i_32363]):null))){
(links_32364[i_32363] = (x__$1.forward[i_32363]));

var G__32367 = (i_32363 + (1));
i_32363 = G__32367;
continue;
} else {
var G__32368 = (i_32363 + (1));
i_32363 = G__32368;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__32381 = nx;
var G__32382 = (level__$1 - (1));
x = G__32381;
level__$1 = G__32382;
continue;
} else {
var G__32384 = x;
var G__32385 = (level__$1 - (1));
x = G__32384;
level__$1 = G__32385;
continue;
}
