...
var G__37920 = o;
reagent.impl.template.goog$module$goog$object.set(G__37920,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37953__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__37953 = function (var_args){
var args = null;
...
while (G__37955__i < G__37955__a.length) {G__37955__a[G__37955__i] = arguments[G__37955__i + 0]; ++G__37955__i;}
  args = new cljs.core.IndexedSeq(G__37955__a,0,null);
} 
return G__37953__delegate.call(this,args);};
G__37953.cljs$lang$maxFixedArity = 0;
G__37953.cljs$lang$applyTo = (function (arglist__37957){
var args = cljs.core.seq(arglist__37957);
return G__37953__delegate(args);
});
...
var G__37924 = o;
reagent.impl.template.goog$module$goog$object.set(G__37924,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37966__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37967__i < G__37967__a.length) {G__37967__a[G__37967__i] = arguments[G__37967__i + 0]; ++G__37967__i;}
  args = new cljs.core.IndexedSeq(G__37967__a,0,null);
} 
return G__37966__delegate.call(this,args);};
G__37966.cljs$lang$maxFixedArity = 0;
G__37966.cljs$lang$applyTo = (function (arglist__37968){
var args = cljs.core.seq(arglist__37968);
return G__37966__delegate(args);
});
...
var G__37925 = props;
var G__37925__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37925,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37925);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37925__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37929 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37929,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37929;
}
})(),id_class);
...
var G__37930 = (cljs.core.count(argv) - first_child);
switch (G__37930) {
case (0):
...
var vec__37931 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37931,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37931,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37931,(2),null);
...
var temp__5757__auto___37981 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37981 == null)){
} else {
var key_37985 = temp__5757__auto___37981;
(jsprops.key = key_37985);
}
...
var temp__5757__auto___37986 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37986 == null)){
} else {
var key_37988 = temp__5757__auto___37986;
(jsprops.key = key_37988);
}
...
var temp__5757__auto___37993 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37993 == null)){
} else {
var key_37994 = temp__5757__auto___37993;
(jsprops.key = key_37994);
}
...
var temp__5757__auto___37996 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37996 == null)){
} else {
var key_38001 = temp__5757__auto___37996;
(jsprops.key = key_38001);
}
...
var temp__5757__auto___38010 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38010 == null)){
} else {
var key_38011 = temp__5757__auto___38010;
(jsprops.key = key_38011);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37943_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37943_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37944 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37944,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37944,(1),null);
...
break;
default:
var G__38019 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38020 = compiler;
v = G__38019;
compiler = G__38020;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37950 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37950 = (function (opts,id,fn_to_element,parse_fn,meta37951){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37950.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37952,meta37951__$1){
var self__ = this;
var _37952__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37950(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37951__$1));
}));

(reagent.impl.template.t_reagent$impl$template37950.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37952){
var self__ = this;
var _37952__$1 = this;
return self__.meta37951;
}));

(reagent.impl.template.t_reagent$impl$template37950.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37950.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37950.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37950.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37950.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37950.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37951","meta37951",575224799,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37950.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37950.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37950");

(reagent.impl.template.t_reagent$impl$template37950.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template37950");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37950.
 */
reagent.impl.template.__GT_t_reagent$impl$template37950 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37950(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37951){
return (new reagent.impl.template.t_reagent$impl$template37950(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37951));
});

}

return (new reagent.impl.template.t_reagent$impl$template37950(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
